...
if prompt_ "Install suggested packages? (recommended)"; then
  PACKAGES="ag ansible coreutils ctags editorconfig git htop httpie node rbenv rbenv-gem-rehash rename ruby-build ssh-copy-id tig tmux tree vim watch zsh"
